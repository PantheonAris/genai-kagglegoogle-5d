...
# This is a placeholder script for deploying the budget agent to Google Cloud Run.
...
docker build -f budget_agent/Dockerfile . -t ${IMAGE_NAME}
...
gcloud run deploy ${SERVICE_NAME} \
  ...
  # For example:
  # --set-env-vars="EXAMPLE_VAR=example_value"
